...
class STMV1(nn.Module):
    ...
    def __init__(self, teacher_backbone_path=None, student_backbone_path=None,
        ...
        self.teacher_backbone_path = teacher_backbone_path or get_backbone_path("efficientnet_b7")
        self.student_backbone_path = student_backbone_path or get_backbone_path("wide_resnet101_2")
