...
def build_modeler(model, modeler_type, **modeler_params):
...
def run_experiment(config):
    try:
        ...
        trainer = build_trainer(modeler, optimizer, config.trainer_type, scheduler=scheduler, stopper=stopper)
