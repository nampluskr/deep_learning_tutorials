...
def get_dataloaders(data_dir, category, batch_size, valid_ratio=0.2,
    ...
    train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True, drop_last=True, **params)
    valid_loader = DataLoader(valid_dataset, batch_size=32, shuffle=False, drop_last=False, **params)
    test_loader = DataLoader(test_dataset, batch_size=32, shuffle=False, drop_last=False, **params)
...
if __name__ == "__main__":
    ...
    train_transform, test_transform = get_transforms(img_size=256, normalize=True)
    ...
    for batch in train_loader:
        print(batch["image"].shape, batch["label"], batch["defect_type"])
        break