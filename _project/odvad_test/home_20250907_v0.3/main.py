...
from config import build_config, save_config, merge_configs
...
def run_experiment(data_type, model_type, overrides=None):
...
if __name__ == "__main__":
    ...
    run_experiment("mvtec", "draem", temp.copy())
    run_experiment("mvtec", "efficientad", temp.copy())