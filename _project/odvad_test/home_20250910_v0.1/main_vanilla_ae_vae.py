import matplotlib
matplotlib.use('Agg')  # GUI 없는 backend 사용
...
from dataloaders import get_dataloaders, IMAGENET_MEAN, IMAGENET_STD, denormalize_imagenet
...
def main():
    ...
    # Load data
    try:
        train_loader, test_loader = get_dataloaders(DATA_DIR, CATEGORY, BATCH_SIZE, IMG_SIZE)
